...
export const productState: PanelState = {
  ...
  messages: [
    {
      id: "gate.edit-set-violation",
      category: "gate",
      defaultSeverity: "blocked",
      defaultTemplate: "{count} file(s) outside the allowed edit set: {files}",
      nonSuppressible: true,
      severity: "blocked",
      text: "{count} file(s) outside the allowed edit set: {files}",
      suppressed: false,
    },
    {
      id: "gate.repo-hygiene.protected-path",
      category: "gate",
      defaultSeverity: "blocked",
      defaultTemplate: "Protected path {path} was touched without owner approval.",
      nonSuppressible: true,
      severity: "blocked",
      text: "Protected path {path} was touched without owner approval.",
      suppressed: false,
    },
    {
      id: "advisory.snapshot.stale",
      category: "advisory",
      defaultSeverity: "attention",
      defaultTemplate: "The committed snapshot looks stale; run `modonome snapshot .` to refresh it.",
      nonSuppressible: false,
      severity: "attention",
      text: "The committed snapshot looks stale; run `modonome snapshot .` to refresh it.",
      suppressed: false,
    },
  ],
};
